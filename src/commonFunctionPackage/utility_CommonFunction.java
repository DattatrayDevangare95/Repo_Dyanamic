...
public class utility_CommonFunction {
	...
	{
		File newFile=new File("C:\\Users\\MIT\\Desktop\\New folder\\" +filename + ".txt");
	...
	public static ArrayList<String> readdataexcels(String sheetname, String testcasename) throws IOException
	{
		...
		FileInputStream fis=new FileInputStream("C:\\Users\\MIT\\Desktop\\New folder\\Post_Test_Data.xlsx");
